...
def transform_metadata(kafka_df, metadata_schema: StructType, topic: str):
    ...
    return (
        ...
        # The parser contract already provides a cross-platform, repo-scoped
        # stable file ID. Reusing it as MongoDB _id makes replace/upsert
        # idempotent and avoids collisions between repositories.
        .withColumn("_id", col("file_id"))
    )
